...
export const EXAMPLE_SOURCES: ExampleSource[] = [
  ...
  },
  {
    ...
    profileLinks: ["https://www.meundies.com"],
  },
  {
    id: "brooklinen",
    label: "BROOKLINEN",
    profileUrl: "https://www.instagram.com/brooklinen/",
    fileName: "brooklinen.json",
    profileBio:
      "Luxury bedding, sheets & bath — https://www.brooklinen.com",
